...
namespace Vostok.Clusterclient.Core.Model
{
    public class Headers_Tests
    {
        ...
        [Theory]
        [InlineData(HeaderNames.Accept, nameof(HeaderNames.Accept))]
        [InlineData(HeaderNames.Age, nameof(HeaderNames.Age))]
        [InlineData(HeaderNames.Authorization, nameof(HeaderNames.Authorization))]
        [InlineData(HeaderNames.ContentEncoding, nameof(HeaderNames.ContentEncoding))]
        [InlineData(HeaderNames.ContentLength, nameof(HeaderNames.ContentLength))]
        [InlineData(HeaderNames.ContentType, nameof(HeaderNames.ContentType))]
        [InlineData(HeaderNames.ContentRange, nameof(HeaderNames.ContentRange))]
        [InlineData(HeaderNames.Date, nameof(HeaderNames.Date))]
        [InlineData(HeaderNames.ETag, nameof(HeaderNames.ETag))]
        [InlineData(HeaderNames.Host, nameof(HeaderNames.Host))]
        [InlineData(HeaderNames.LastModified, nameof(HeaderNames.LastModified))]
        [InlineData(HeaderNames.Location, nameof(HeaderNames.Location))]
        [InlineData(HeaderNames.Range, nameof(HeaderNames.Range))]
        [InlineData(HeaderNames.Referer, nameof(HeaderNames.Referer))]
        [InlineData(HeaderNames.RetryAfter, nameof(HeaderNames.RetryAfter))]
        [InlineData(HeaderNames.Server, nameof(HeaderNames.Server))]
        [InlineData(HeaderNames.TransferEncoding, nameof(HeaderNames.TransferEncoding))]
        [InlineData(HeaderNames.UserAgent, nameof(HeaderNames.UserAgent))]
        [InlineData(HeaderNames.WWWAuthenticate, nameof(HeaderNames.WWWAuthenticate))]

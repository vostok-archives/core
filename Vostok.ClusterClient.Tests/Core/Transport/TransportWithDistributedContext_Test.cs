...
namespace Vostok.Clusterclient.Core.Transport
{
    public class TransportWithDistributedContext_Test
    {
        ...
        [Theory]
        [InlineData("key", "value", HeaderNames.XDistributedContextPrefix + XDistributedContextSeparator + "key", "string|value")]
        [InlineData("ключ", "значение", HeaderNames.XDistributedContextPrefix + XDistributedContextSeparator + "%d0%ba%d0%bb%d1%8e%d1%87", "string|%d0%b7%d0%bd%d0%b0%d1%87%d0%b5%d0%bd%d0%b8%d0%b5")]
